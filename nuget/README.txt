...
== Recommendations
1. Install the following ImageResizer plugins:
  - ImageResizer.Plugins.DiskCache: automatically manages caching of images on disk
  - ImageResizer.WebConfig: sets the relevant web.config settings for your solution
